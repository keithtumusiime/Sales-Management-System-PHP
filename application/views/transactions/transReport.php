        ...
        <div class="container margin-top-5">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h4>Everce Kyomuhendo Stationaries</h4>
                </div>
            </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $get->ref ?></td>
                                        <td><?= $get->quantity ?></td>
                                        <td>UGX <?= number_format($get->totalMoneySpent, 2) ?></td>
                                        <td>UGX <?= number_format($get->amountTendered, 2) ?></td>
                                        <td>UGX <?= number_format($get->changeDue, 2) ?></td>
            ...
            <div class="row" style="margin-bottom: 10px">
                ...
                <div class="col-xs-6 text-right">
                    <h4>Total Earned: UGX <?=number_format($total_earned, 2)?></h4>
                </div>
            </div>
        </div>
        <!--- panel end-->
